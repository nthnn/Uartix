...
public final class OpsKeys {
    ...
    public static List<String> keywords = Arrays.asList("while", "do", "loop", "render", "unless", "if", "else", "when", "break", "continue", "random", "func", "ret", "true", "false", "nil", "catch", "handle", "throw", "maybe", "then", "type", "use", "test");
}
